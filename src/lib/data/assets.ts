...
const Assets = {
	...
	AndroidStudio: asset('android.png'),
	...
	Concordia: asset('concordia.png'),
	Vanier: asset('vanier.png'),

	DuctTape: asset('ducttape.png'),
	DBDPerkMaker: asset('dbdperkmaker.png'),
	TheOutlaw: asset('theoutlaw.png'),
	Blog: asset('blog.png'),
	Scramblecoin: asset('scramblecoin.png'),
	ZombieApocalypse: asset('zombieapocalypse.png'),
	Stardew: asset('stardew.png'),
	Commerce: asset('commerce.png'),
	FamilyFeud: asset('familyfeud.png'),
	Jeopardy: asset('jeopardy.png'),
	Calculator: asset('calculator.png'),
	Chess: asset('chess.png'),
	Grocery: asset('grocery.png'),
	Risk: asset('risk.png'),
	Battleship: asset('battleship.png'),
	Discord: asset('discord.png'),
	Reddit: asset('reddit.png'),

	Cryopak: asset('cryopak.png'),
	Croogloo: asset('croogloo.png'),
	Airbus: asset('airbus.png'),
	Genetec: asset('genetec.png'),
	Tutor: asset('tutor.png'),
	Laurus: asset('laurus.png'),
	StudentWorks: asset('studentworks.png'),
};
